    ...
    <div class="card-body">
      <div class="gauge-container">
        ...
        <div class="model-stats">
          ...
          <div class="model-row">
            <div class="model-label">gemini-3-flash</div>
            <div class="model-bar">
              <div class="model-bar-fill flash" :style="{ width: getPercentage('gemini-3-flash-preview') + '%' }"></div>
            </div>
            <div class="model-value">{{ getUsageText('gemini-3-flash-preview') }}</div>
          </div>
          <div class="model-row">
...
const getTotalLimit = () => {
    ...
    if (typeof l === 'object' && l.total !== undefined) return l.total;
...
const getModelLimit = (model: string) => {
    ...
    if (typeof l === 'number') return l;
    // 新格式：对象，返回对应模型的配额
    if (model.includes('3-flash')) return l.v3 || 0;
